...
public class StudentPanel extends JPanel implements ActionListener
{
	...
	private StudentPanel() 
	{
		...
		table.getTableHeader().setBackground(new Color(128, 0, 128, 220));
		...
		studentslabel.setBackground(new Color(128, 0, 128, 0));
		...
		studentslabel.setOpaque(false);
		   ...
		   viewstudentbutton.setForeground(new Color(128, 0, 128));
		  ...
		  addstudentbutton.setForeground(new Color(128, 0, 128));
		 ...
		 viewbutton.addActionListener(this);
		  viewbutton.setForeground(new Color(128, 0, 128));
		  ...
		  maxphotospinner.setFont(new Font("Segoe UI", Font.PLAIN, 17));
