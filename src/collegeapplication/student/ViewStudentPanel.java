...
*/
	private ViewStudentPanel(Student s)
	{
		...
		lblCource.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		lblFatherName.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		lblFatherOccupation.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		lblMotherName.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		lblMotherOccupation.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		fathernamelabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
		...
		fatheroccupationlabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
		...
		mothernamelabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
		...
		motheroccupationlabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
	...
	public ViewStudentPanel(Student s,AdminMain am,JComponent lastpanel)
	{
		...
		lblAdmissionDate.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		admissiondatelabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
