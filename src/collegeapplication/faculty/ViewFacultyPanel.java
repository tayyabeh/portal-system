...
public class ViewFacultyPanel extends JPanel {
	...
	private ViewFacultyPanel(Faculty f)
	{
		...
		panel.setBackground(new Color(128, 0, 128, 220));
		...
		backbutton.setBackground(new Color(128, 0, 128, 220));
		...
		lblLastLogin.setFont(new Font("Segoe UI", Font.BOLD, 15));
		...
		facultyidlbl.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		facultynamelbl.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		qualificationlbl.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		semoryearlbl.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		lblsubject.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		positionlbl.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		facultyidlabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
		...
		facultynamelabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
		...
		emailidlabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
		...
		qualificationlabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
		...
		postionlabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
		...
		add(profilepiclabel);
				...
				profilepiclabel.setFont(new Font("Segoe UI", Font.PLAIN, 16));
				...
				lblsemoryear.setFont(new Font("Segoe UI", Font.PLAIN, 20));
				...
				experiencelabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
	...
	public ViewFacultyPanel(Faculty f, AdminMain am,JComponent lastpanel)
	{
		...
		lblJoinedDate.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		joineddatelabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
