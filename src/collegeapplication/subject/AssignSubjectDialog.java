...
public class AssignSubjectDialog extends JDialog implements ActionListener {
	...
	private AssignSubjectDialog(Faculty f) {
		...
		lblCourceName.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		...
		lblSelectSemyear.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		...
		lblSubject.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		...
		lblPosition.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		...
		assignsubjectbutton.setBackground(new Color(128, 0, 128));
