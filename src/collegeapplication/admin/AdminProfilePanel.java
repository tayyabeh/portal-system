...
public class AdminProfilePanel extends JPanel {
	...
	public AdminProfilePanel(AdminMain am)
	{
		...
		// Changed to Purple
		editdetailsbutton.setForeground(new Color(128, 0, 128));
		...
		// Changed to Purple
		editlinksbutton.setForeground(new Color(128, 0, 128));
	...
	public AdminProfilePanel() {
		...
		// Changed to Purple Transparent (Must match panel bg for consistency if opaque)
		headinglabel.setBackground(new Color(128, 0, 128, 0)); // Transparent since panel has color
		headinglabel.setHorizontalAlignment(SwingConstants.LEFT);
		headinglabel.setForeground(Color.WHITE);
		headinglabel.setFont(new Font("Segoe UI", Font.BOLD, 30));
		headinglabel.setOpaque(false); // Make transparent to show panel bg
